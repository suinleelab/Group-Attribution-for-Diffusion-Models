...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="evaluate Add-One-In values using the linear model score"
    )
    parser.add_argument(
        "--dataset",
        type=str,
...
def main(args):
    ...
    # Collect null (pretrained) model behaviors.
    ...
    fit_df["idx"] = fit_df["exp_name"].str.split("aoi_idx_", expand=True)[1].astype(int)
    ...
    # Get Add-One-In scores and evaluate LDS.
    attrs_all = y_fit - y_null
