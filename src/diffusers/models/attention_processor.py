...
def my_get_processor(self, return_deprecated_lora: bool = False) -> "AttentionProcessor":
    r"""
...
class LoRAAttnProcessor2_0(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        k_rank = kwargs.pop("k_rank", None)
        k_hidden_size = kwargs.pop("k_hidden_size", None)
        k_rank = k_rank if k_rank is not None else rank
        k_hidden_size = k_hidden_size if k_hidden_size is not None else hidden_size
        ...
        self.to_q_lora = LoRALinearLayer(q_hidden_size, q_hidden_size, q_rank, network_alpha)
        self.to_k_lora = LoRALinearLayer(cross_attention_dim or k_hidden_size, k_hidden_size, k_rank, network_alpha)
        self.to_v_lora = LoRALinearLayer(cross_attention_dim or v_hidden_size, v_hidden_size, v_rank, network_alpha)
        self.to_out_lora = LoRALinearLayer(out_hidden_size, out_hidden_size, out_rank, network_alpha)
